...
public class BillsFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form BillsFrame
     */
   
    public BillsFrame() throws Exception {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "التاريخ", "المجموع", "سعر الكيلو", "عدد الاقفاص", "الوزن بدون الاقفاص", "الوزن"
            }
        ) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(BillsFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
